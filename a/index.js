...
import {generateProof} from './ZKsecret/dist/proof/GenProof.js';

import {Register} from './ZKsecret/dist/register.js';
import {VerifyProof} from './ZKsecret/dist/proof/VerifyProof.js';
 ...
 */
async function exampleSeparateUsage(userId, password) {
...
async function testSeparateFunctions() {
  try {
    await exampleSeparateUsage("fgufy", "password123");
  } catch (error) {
